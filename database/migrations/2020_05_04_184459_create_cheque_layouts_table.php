...
class CreateChequeLayoutsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cheque_layouts', function (Blueprint $table) {
            ...
            $table->integer('date_font_size')->default(14);
            $table->integer('date_letter_spacing')->default(0);
            $table->boolean('payee')->default(1);
            $table->integer('payee_top')->nullable();
            $table->integer('payee_left')->nullable();
            $table->integer('payee_font_size')->default(14);
            $table->integer('payee_letter_spacing')->default(0);
            $table->boolean('amount')->default(1);
            $table->integer('amount_top')->nullable();
            $table->integer('amount_left')->nullable();
            $table->integer('amount_font_size')->default(14);
            $table->integer('amount_letter_spacing')->default(0);
            ...
            $table->integer('amount_in_word_font_size')->default(14);
            $table->integer('amount_in_word_letter_spacing')->default(0);
            $table->integer('amount_in_word_max_character')->default(50);
