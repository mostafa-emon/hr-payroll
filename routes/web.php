...
Route::get('/mr-transactions', 'MRTransactionController@index');
Route::post('/mr-transactions/add', 'MRTransactionController@add');
Route::get('/mr/print/{id}', 'MRTransactionController@print');
