          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-4 mg-t--1 mg-md-t-0">
              <div class="form-group bd-t-0-force">
                ...
                <input class="form-control" type="text" id="no_of_leaves" name="no_of_leaves" placeholder="Enter No. of Leaves" value="{{$cheque_book->no_of_leaves}}">
              </div>
            </div>
            ...
            <div class="col-md-4 mg-t--1 mg-md-t-0">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                ...
                <input class="form-control" type="text" oninput="set_ending_number(this.value)" name="starting_number" placeholder="Enter Starting Number" value="{{$cheque_book->starting_number}}">
              </div>
            </div>
            ...
            <div class="col-md-4 mg-t--1 mg-md-t-0">
              <div class="form-group mg-md-l--1 bd-t-0-force">
                ...
                <input class="form-control" type="text" id="ending_number" name="ending_number" placeholder="Enter Ending Number" value="{{$cheque_book->ending_number}}">
              </div>
            </div>
