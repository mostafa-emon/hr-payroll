    ...
    <div class="card">
      <div style="margin-top:-10px;" class="row">
        ...
        <div class="col-md-2">
          <li id="date_list">
            <label class="ckbox pointer">
              <input type="checkbox" onclick="hideShowElement('reference_no')" id="reference_no_checkbox" name="reference_no" value="1" @if($voucher_formats->reference_no == 1) checked @endif><span>Reference No</span>
            </label>
