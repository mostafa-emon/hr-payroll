    ...
    <div class="card">
      <div style="margin-top:-10px;" class="row">
        ...
        <div class="col-md-2">
          <li id="date_list">
            <label class="ckbox pointer">
              <input type="checkbox" onclick="hideShowElement('reference_no')" id="reference_no_checkbox" name="reference_no" value="1" @if($voucher_formats->reference_no == 1) checked @endif><span>QB Ref No</span>
            </label>
          ...
          <div class="card pd-0 bd-0 pd-30 table-responsive">
            ...
            <div id="printArea">
              <div id="containment-wrapper" style="height: {{$page_height}}mm; width: 210mm; position: relative">
                ...
                <div id="qblogo" onclick="qbLogoDrag();" class="draggable ui-widget-content" style="position: absolute;top: {{$voucher_formats->qb_logo_top}}mm;left: {{$voucher_formats->qb_logo_left}}mm"><img src="{{ asset('storage/'.$company->logo) }}" height="35"/></div>
                ...
                <div id="location" onclick="locationDrag()" class="draggable ui-widget-content" style="@if($voucher_formats->location != 1) display:none; @endif position: absolute; top: {{$voucher_formats->location_top}}mm; left: {{$voucher_formats->location_left}}mm; font-family: Arial; font-size: 13px; font-weight:bold; color: black; background-color:rgba(60, 141, 188, 0.5); padding-right: 200px; border-right: 7px solid red;">Location</div>
                <div id="reference_no" onclick="referenceNoDrag()" class="draggable ui-widget-content" style="@if($voucher_formats->reference_no != 1) display:none; @endif position: absolute; top: {{$voucher_formats->reference_no_top}}mm; left: {{$voucher_formats->reference_no_left}}mm; font-family: Arial; font-size: 13px; font-weight:bold; color: black; background-color:rgba(60, 141, 188, 0.5); padding-right: 10px; border-right: 7px solid red;">QB Ref No : </div>
