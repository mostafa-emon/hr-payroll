    ...
    <div class="card">
      <div style="margin-top:-10px;" class="row">
        ...
        <div class="col-md-3">
          <li id="date_list">
            <label class="ckbox pointer">
              <input type="checkbox" onclick="hideShowElement('received_from')" id="received_from_checkbox" name="received_from" value="1" checked><span>Received From</span>
            </label>
          ...
          <div class="card pd-0 bd-0 pd-30 table-responsive">
            ...
            <div id="printArea">
              <div id="containment-wrapper" style="height: {{$page_height}}mm; width: 210mm; position: relative">
                ...
                <div id="payee_name" onclick="payeeNameDrag()" class="draggable ui-widget-content" style="display:none;position: absolute; top: 35mm; left: 10mm; font-family: Arial; font-size: 13px; font-weight:bold; color: black; background-color:rgba(60, 141, 188, 0.5); padding-right: 200px; border-right: 7px solid red;">Payee Name</div>
                <div id="cheque_name" onclick="chequeNameDrag()" class="draggable ui-widget-content" style="display:none;position: absolute; top: 23mm; left: 0mm; font-family: Arial; font-size: 13px; font-weight:bold; color: black; background-color:rgba(60, 141, 188, 0.5); padding-right: 200px; border-right: 7px solid red;">Cheque No</div>
                <div id="cheque_date" onclick="chequeDateDrag()" class="draggable ui-widget-content" style="display:none;position: absolute; top: 0mm; left: 0mm; font-family: Arial; font-size: 13px; font-weight:bold; color: black; background-color:rgba(60, 141, 188, 0.5); padding-right: 200px; border-right: 7px solid red;">Cheque Date</div>
                <div id="received_from" onclick="receivedFromDrag()" class="draggable ui-widget-content" style="position: absolute; top: 28mm; left: 10mm; font-family: Arial; font-size: 13px; font-weight:bold; color: black; background-color:rgba(60, 141, 188, 0.5); padding-right: 200px; border-right: 7px solid red;">Received From</div>
