    ...
    <div class="card">
      <div style="margin-top:-10px;" class="row">
        ...
        <div class="col-md-3">
          <li id="date_list">
            <label class="ckbox pointer">
              <input type="checkbox" onclick="hideShowElement('received_from')" id="received_from_checkbox" name="received_from" value="{{$voucher_formats->received_from}}" checked><span>Received From</span>
            </label>
