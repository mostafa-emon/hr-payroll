        ...
        <table class="table table-striped mg-b-0">
          <thead>
            <tr>
              ...
              @if(roles() != "" && (in_array(35, json_decode(roles(),false)) || in_array(36, json_decode(roles(),false)) ))
                    ...
                    <div class="dropdown-menu">
                      @if($is_printed > 0)
                        @if(roles() != "" && in_array(36, json_decode(roles(),false)))
                          <a class="dropdown-item pointer" href="{{url('cheque-reprint/'.$apiType.'/'.$dt['Id'])}}">Re Print</a>
                        @endif
                        @if(roles() != "" && in_array(35, json_decode(roles(),false)))
                          <a class="dropdown-item pointer" onclick="void_cheque('{{$apiType}},{{$dt['Id']}}')" href="javascript:void(0)">Void</a>
                        @endif
                      @else
                        @if(roles() != "" && in_array(36, json_decode(roles(),false)))
