...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('company-register')}}" style="color:#6c757d;">Subscription Company</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                      <div class="col-md-6" style="padding-top:5px">
                        <h4 class="card-title mg-b-0">Subscription</h4>
                      </div>
                ...
                <div class="card-body">
                    <div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
                  <form method="POST" action="{{ url('company-register') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
