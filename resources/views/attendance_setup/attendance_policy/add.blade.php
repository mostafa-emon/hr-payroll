...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/attendance-policy/add')}}" style="color:#6c757d;">Add</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">ADD Attendance Policy</h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
                                    <form method="POST" action="{{url('attendance-policy/add')}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="pd-30 pd-sm-40 bg-gray-200">
                                            <div class="row row-xs">
                                                ...
                                                <div class="col-md-4 mg-t-8">
                                                    <input class="form-control" placeholder="10:00" name="start_time" type="text" required>
                                                </div>
                                                ...
                                                <div class="col-md-4 mg-t-8">
                                                    <input class="form-control" name="end_time" placeholder="06:00" type="text" required>
                                                </div>
                                                <div class="col-md-2 mg-t-8">
                                                ...
                                                <div class="col-md-6 mg-t-10">
                                                    ...
                                                    <input class="form-control" name="late_mark" placeholder="Minutes" type="text" required>
                                                </div>
                                                ...
                                                <div class="col-md-6 mg-t-10">
                                                    ...
                                                    <input class="form-control" name="marks_absent_for" placeholder="Days Late in a month" type="text" required>
                                                </div>
                                                ...
                                                <div style="display:none;" id="ot_round_slab" class="col-md-6 mg-t-10">
                                                    <label for="name" class="col-form-label">OT Round off Slab:</label>
                                                    <input class="form-control" name="ot_round" placeholder="Minutes" type="text">
                                                </div>

                                                <div class="col-md-6 mg-t-10">
                                                    <label for="name" class="col-form-label">Minimum time need to stay for considering as OT:</label>
                                                    <input class="form-control" name="time_for_ot" placeholder="Minutes" type="text" required>
                                                </div>
                                                <div class="col-md-6 mg-t-10">
