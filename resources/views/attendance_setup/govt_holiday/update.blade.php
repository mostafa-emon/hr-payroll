...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/govt-holiday/update/'.$holiday->id)}}" style="color:#6c757d;">Update</a></li>
            </ol>
            </div>
        </div>
                                        ...
                                        <div class="pd-30 pd-sm-40 bg-gray-200">
                                            <div class="row row-xs">
                                                <div class="col-md-6 mg-t-10">
                                                    <input class="form-control" placeholder="Name" name="name" value="{{$holiday->name}}" type="text">
                                                </div>
                                                <div class="col-md-6 mg-t-10">
