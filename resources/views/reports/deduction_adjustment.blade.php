...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/deduction-adjustment-report')}}" style="color:#6c757d;">Deduction Adjustment Report</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">Deduction Adjustment Report</h4>
                        </div>
                        <div class="col-md-6 text-right">
                            @if(count($employees) > 0)
                            <a href="{{url('deduction-adjustment-report')}}" class="btn btn-info">Reset</a>
                    ...
                    <hr>
                    @if(count($employees) == 0)
                    <form action="{{ url('deduction-adjustment-report') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <label for="Employee" style="font-weight:bold;" class="col-form-label">Salary Component:</label>
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="employee_id" name="employee_id" class="form-control select2-no-search" @if(count($employees) > 0) disabled @endif>
                                    ...
                                    @foreach($select_employees as $employment_info)
                                        <option value="{{$employment_info->employee_id}}">{{$employment_info->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    @if(count($employees) > 0)
                        <div class="card-body" id="printArea">
                            <div class="div-padding-30">
                                @include('reports.exports.deduction_adjustment_report_table',$employees)
    ...
    <script>
        function get_employee() {
            ...
            var url = '/search-increment-employee_id-with-designation/'+department_id;
            ...
            $.ajax({
                ...
                success:function(data) {
                    console.log(data)
                    $('#employee_id').html('');
                    $('#employee_id').append('<option label="All"></option>');
