...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/daily-absent-report')}}" style="color:#6c757d;">Daily Absent Report</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">Daily Absent Report</h4>
                        </div>
                        <div class="col-md-6 text-right">
                            @if(count($employee_id) > 0)
                            <a href="{{url('daily-absent-report')}}" class="btn btn-info">Reset</a>
                    ...
                    <hr>
                    @if(count($employee_id) == 0)
                    <form action="{{ url('daily-absent-report') }}" method="POST">
                        {{ csrf_field() }}
                    ...
                    @if(count($employee_id) > 0)
                        <div class="card-body" id="printArea">
                            <div class="div-padding-30">
                                @include('reports.exports.daily_absent_list_table',$employees)
