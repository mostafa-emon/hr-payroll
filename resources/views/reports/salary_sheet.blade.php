...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/salary-sheet-report')}}" style="color:#6c757d;">Salary Sheet Report</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">Salary Sheet Report</h4>
                        </div>
                    ...
                    <hr>
                    @if(count($employment_infos) == 0)
                    <form action="{{ url('salary-sheet-report') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                    ...
                    @if(count($employment_infos) > 0)
                        <div class="card-body" id="printArea">
                            <div class="div-padding-30">
                                @include('reports.exports.salary_sheet_list_table',$employment_infos)
