...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/email-payslip-report')}}" style="color:#6c757d;">Email Pay Slip Report</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">Email Pay Slip Report</h4>
                        </div>
                        <div class="col-md-6 text-right">
                            @if(count($employment_infos) > 0)
                                <a href="{{url('email-payslip-report')}}" class="btn btn-info">Reset</a>
                            @endif
                        </div>
                    </div>
                    <hr>
                    @if(count($employment_infos) == 0)
                    <form action="{{ url('email-payslip-report') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                    ...
                    @if(count($employment_infos) > 0)
                        <div class="card-body" id="printArea">
                            <div class="div-padding-30">
                                @include('reports.exports.email_payslip_list_table',$employment_infos)
