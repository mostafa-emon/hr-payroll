...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/earning-adjustment-report')}}" style="color:#6c757d;">Earning Adjustment Report</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">Earning Adjustment Report</h4>
                        </div>
                        <div class="col-md-6 text-right">
                            @if(count($employees) > 0)
                            <a href="{{url('earning-adjustment-report')}}" class="btn btn-info">Reset</a>
                    ...
                    <hr>
                    @if(count($employees) == 0)
                    <form action="{{ url('earning-adjustment-report') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                    ...
                    @if(count($employees) > 0)
                        <div class="card-body" id="printArea">
                            <div class="div-padding-30">
                                @include('reports.exports.earning_adjustment_report_table',$employees)
