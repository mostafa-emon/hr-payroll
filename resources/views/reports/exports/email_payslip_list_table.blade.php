<div class="table-responsive">  
  <table style="width:100%;">
    <thead>
        ...
        <tr>
          <th colspan="13" style="font-size:15px;text-align:center;border:none;">Email Pay Slip Report</th>
        </tr>
    ...
    <tbody>
        <tr>
            ...
            @if($hide_detail_btn != 'Yes')
              ...
              <td style="text-align:center;vertical-align:middle;">
                <a href="{{url('salary-sheet-details-print/'.$employee->employee_id.'/'.$month.'/'.$year)}}" class="btn btn-primary btn-sm">Print</a>
              </td>
              <td style="text-align:center;vertical-align:middle;">
                <a href="{{url('mail-pay-slip-single-employee/'.$employee->employee_id.'/'.$month.'/'.$year)}}" class="btn btn-info btn-sm">Email</a>
              </td>
            @endif
        </tr>
