<div class="table-responsive">  
  <table style="width:100%;">
    <thead>
        ...
        <tr>
          <th colspan="{{$total_month + 6}}" style="font-size:15px;text-align:center;border:none;">Deduction Adjustment Report</th>
        </tr>
          ...
          @foreach($period as $dt)
            ...
            @foreach($employees as $employee_list)
              @if($employee_list->salary_component_id == $old_salary_component_id)
                @php 
                  $component_amount = get_deduction_component_amount($employee_list->employee_id,$employee_list->salary_component_id,$dt->format("M-Y"));
        ...
        <tr>
            ...
            @foreach($period as $dt)
              <td style="text-align: center;">
                @php 
                  $component_amount = get_deduction_component_amount($employee->employee_id,$employee->salary_component_id,$dt->format("M-Y"));
