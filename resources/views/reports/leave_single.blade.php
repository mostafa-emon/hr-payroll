...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/leave-report-single')}}" style="color:#6c757d;">Leave Report Individual</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <a href="{{url('leave-report-single')}}" class="btn btn-info">Reset</a>
                    ...
                    <hr>
                    @if(count($employees) == 0)
                    <form action="{{ url('leave-report-single') }}" method="POST">
                        {{ csrf_field() }}
                    ...
                    @if(count($employees) > 0)
                        <div class="card-body" id="printArea">
                            <div class="div-padding-30">
                                @include('reports.exports.leave_list_single_table',$employees)
