...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{url('/leave-request')}}" style="color:#6c757d; font-weight: bold">Create Leave Request</a></li>
                <li class="breadcrumb-item active"><a href="{{url('/leave-request/add')}}" style="color:#6c757d;">Add</a></li>
            </ol>
            </div>
        </div>
