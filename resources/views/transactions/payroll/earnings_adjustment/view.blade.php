        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="printArea">
                        @php 
                        $employee = get_employee_info($earning->employee_id);
                        @endphp
                            ...
                            <table style="width:100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align:center;">{{$earning->month}}</td>
                                        <td style="text-align:center;">{{$earning->year}}</td>
                                        <td style="text-align:center;">{{$earning->amount}}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <div style="margin-top:25px;font-size:16px;">
                                <div style="font-weight:bold;">Note:</div> {{$earning->note}}
                            </div>
                        </div>
