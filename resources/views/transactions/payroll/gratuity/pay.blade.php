...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/gratuity-pay')}}" style="color:#6c757d;">Pay</a></li>
            </ol>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <hr>
                    <form action="{{ url('gratuity-pay') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-3">
    ...
    <script>
        ...
        function confirmpay(id) {
            ...
            if (r == true) {
            window.location = "/gratuity-pay-store/"+id;
            }
        }
    </script>
