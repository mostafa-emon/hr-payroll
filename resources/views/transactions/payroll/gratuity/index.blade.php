...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/gratuity')}}" style="color:#6c757d;">Gratuity</a></li>
            </ol>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">Gratuity</h4>
                        </div>
    ...
    <script>
        ...
        function confirmDelete(id) {
            ...
            if (r == true) {
            window.location = "/gratuity/delete/"+id;
            }
        }
