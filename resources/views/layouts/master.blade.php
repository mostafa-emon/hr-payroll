			...
			<aside class="app-sidebar sidebar-scroll">
				...
				<div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
						...
						<li class="slide  {{ (request()->is('subscripion*')) || (request()->is('company-register*')) ? 'active' : '' }}">
							<a class="side-menu__item {{ (request()->is('subscripion*')) || (request()->is('company-register*')) ? 'active' : '' }}" href="{{url('/subscription')}}">
                        ...
                        <li class="slide
                            {{ (!request()->is('company')) && (request()->is('company*')) ? 'is-expanded' : '' }}">
                            
                            <a class="side-menu__item {{ (request()->is('company*')) ? 'active' : '' }}" data-toggle="slide" href="javascript:void(0)">
