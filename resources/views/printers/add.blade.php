...
@section('content')
  ...
  <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5">Add Printer</h4>
  </div>

  <form action="{{ url('printer/add') }}" method="POST">
    {{ csrf_field() }}
          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="print_name" placeholder="Enter Printer Name">
              </div>
            </div>
