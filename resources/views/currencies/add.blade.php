...
@section('content')
  ...
  <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5">Add Currency</h4>
  </div>

  <form action="{{ url('currency/add') }}" method="POST">
    {{ csrf_field() }}
          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-4 mg-t--1 mg-md-t-0">
              <div class="form-group mg-md-l--1">
                ...
                <input class="form-control" type="text" name="fraction_name" placeholder="Enter Fraction Name" required>
              </div>
            </div>
            ...
            <div class="col-md-4 mg-t--1 mg-md-t-0">
              <div class="form-group mg-md-l--1">
                ...
                <label class="ckbox pointer">
                  <input type="checkbox" name="default" value="1"><span>Make Default</span>
                </label>
              </div>
            </div>
