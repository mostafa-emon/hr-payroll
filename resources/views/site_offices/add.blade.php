...
@section('content')
  ...
  <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5">Add Site Office</h4>
  </div>

  <form action="{{ url('site-office/add') }}" method="POST">
    {{ csrf_field() }}
          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-4">
              <div class="form-group bd-t-0-force">
                ...
                <input class="form-control" type="text" name="mr_prefix" placeholder="MR Prefix">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group bd-t-0-force mg-md-l--1">
                ...
                <input class="form-control" type="text" name="mr_suffix" placeholder="MR Suffix">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group bd-t-0-force mg-md-l--1">
                ...
                <input class="form-control" type="text" name="mr_start_from" placeholder="MR Start From">
              </div>
            </div>
