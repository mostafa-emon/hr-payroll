...
<div id="printArea">
    <div id="containment-wrapper" style="font-family: Arial; padding:30px">
        ...
        <div style="float: right; padding-bottom: 10px;">
            ...
            <div style="float: right; border: 1px solid; height: 22px; width: 47%; margin-top: -24px; text-align: center; padding-top: 4px;">{{ $setting->mr_prefix }}{{ $transaction->invoice_no }}{{ $setting->mr_suffix }}</div>
            </div><br><br>
            <div>
        ...
        <div style="margin-top: 100px; float: left; margin-bottom: 80px;">
        ...
        <div style="margin-top: 100px; float: right; margin-bottom: 80px;">
            <div style="text-align: center;">
            </div>
            <br>
