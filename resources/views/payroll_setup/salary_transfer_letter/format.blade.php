...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{url('/salary-transfer-letter-format')}}" style="color:#6c757d;">Salary Transfer Letter Format</a></li>
            </ol>
            </div>
        </div>
    ...
    <div class="row row-sm">
        ...
        <!--div-->
        <div class="col-xl-12">
            <form action="{{url('salary-transfer-letter-format')}}" method="POST">
                {{ csrf_field() }}
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">Salary Transfer Letter Top</h4>
                        </div>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6" style="padding-top:5px">
                            <h4 class="card-title mg-b-0">Salary Transfer Letter Bottom</h4>
                        </div>
