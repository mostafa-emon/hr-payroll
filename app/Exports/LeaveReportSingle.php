...
class LeaveReportSingle implements FromView
{
    public function view(): View
    {
        ...
        return view('reports.exports.leave_list_single_table',compact('employees','employee_selection','from_date','to_date','leave_types'));
    }
}
