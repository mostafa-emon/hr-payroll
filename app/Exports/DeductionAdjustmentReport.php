...
class DeductionAdjustmentReport implements FromView
{
    public function view(): View
    {
        ...
        return view('reports.exports.deduction_adjustment_report_table',compact('employees','from_date','to_date','period'));
    }
}
