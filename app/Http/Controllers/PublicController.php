        ...
        if($count == 0) {
            ...
            foreach($records as $record) {
                ...
                if($record->record_type == "IN") {
                    ...
                    }else if($record->attendance_status == "WEEKLY_HOLIDAY" || $record->attendance_status == "PAID_LEAVE") {
